describe("Register Page", () => {
  ...
  it.skip("Should redirect to home page when user is already registered", () => {});

  it.skip("Should render the register page successfully", () => {});
  ...
  it.skip("Should be able to register successfully", () => {});
});
